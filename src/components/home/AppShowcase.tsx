  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-20">
      ...
      <div className="mt-14 grid gap-4 lg:grid-cols-[1fr_1.7fr_1fr]">
        {/* Row 1 — left: toolkit */}
        <div className="flex flex-col rounded-3xl border border-black/[0.06] bg-white p-6 shadow-sm">
          ...
          <p className="mt-8 text-lg font-semibold tracking-tight text-foreground">
            All-in-One <span className="text-gradient-brand">SMS Toolkit</span>
          </p>
        ...
        <div className="flex flex-col justify-center rounded-3xl bg-[#f6f0fb] p-8">
        ...
        <div className="flex flex-col gap-4 lg:row-span-2">
          ...
          <div className="flex flex-1 flex-col overflow-hidden rounded-3xl border border-black/[0.06] bg-white p-6 shadow-sm">
            ...
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
              SMSLocal&apos;s multi-language support lets you create and connect
              globally.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center rounded-3xl bg-[#fdf3ee] p-7 text-center">
            ...
            <p className="mt-4 text-sm font-medium text-foreground">
              Trusted by <span className="text-gradient-brand">20,000+</span>{" "}
              global businesses.
            </p>
        ...
        <div className="flex flex-col overflow-hidden rounded-3xl bg-[#eceefb] p-6 text-center">
          <div
            ...
            style={{
              maskImage: "linear-gradient(to bottom, #000 55%, transparent 97%)",
              WebkitMaskImage:
            ...
            <div className="relative flex-1 overflow-hidden rounded-t-[1.6rem] bg-white pt-4">
              ...
              <div className="grid grid-cols-2 gap-2 p-3">
                {TILES.map(({ icon: Icon, label, tint }) => (
                  <div key={label} className="rounded-xl bg-muted/60 p-2 text-left">
                    <span

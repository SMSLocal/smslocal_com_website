...
import BuildingBlocksReveal from '../components/BuildingBlocksReveal.jsx'
import BuilderJourneyPath from '../components/BuilderJourneyPath.jsx'
import { IconCursor, IconBrain, IconRocket, IconFlask, IconPlug, IconGear, IconLink } from '../components/icons.jsx'
import BotOrbitStage from '../components/BotOrbitStage.jsx'
...
const TESTIMONIALS = [
  { quote: 'We built our first support bot in an afternoon and it now handles most of our repeat questions without a human touching them.', name: 'Priya Nair', role: 'Support Lead' },
  { quote: 'The conditional logic is what sold us — we route by order status and business hours without writing a single rule in code.', name: 'Marcus Bello', role: 'Ecommerce Founder' },
  { quote: 'Publishing the same flow to WhatsApp and our website saved us weeks of separate integration work.', name: 'Elena Kovac', role: 'Head of Growth' },
]
...
function ChatbotBuilder() {
  return (
    <>
      ...
      <BuilderJourneyPath eyebrow="How it works" title={<>From idea to live bot in three steps</>} steps={STEPS} />

      <Testimonials title={<>Trusted by teams building on SMSLocal</>} items={TESTIMONIALS} />

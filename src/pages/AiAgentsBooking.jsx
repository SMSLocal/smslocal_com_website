  ...
  return (
    <>
      <Seo
        ...
        description="Book appointments and reservations inside the chat with an agentic AI agent that checks live availability and confirms instantly, cutting no-shows."

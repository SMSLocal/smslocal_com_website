...
const ECOSYSTEM = [
  ...
  { icon: <IconChat />, title: 'SMS broadcasting', desc: 'The universal safety net — when a device can’t receive RCS, the same send still lands as plain SMS.' },
  ...
  { icon: <IconMail />, title: 'Omnichannel inbox', desc: 'Every RCS reply lands right beside WhatsApp, SMS and social replies — all inside one shared team inbox.' },
]
  ...
  return (
    <>
      <Seo
        ...
        description="Upgrade SMS to RCS with rich media and automatic fallback, at scale."

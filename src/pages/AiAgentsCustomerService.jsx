  ...
  return (
    <>
      <Seo
        ...
        description="Resolve customer queries autonomously with an AI service agent. 24/7 resolutions across chat, email, voice and social, with full-context human handoff."

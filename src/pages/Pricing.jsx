  ...
  return (
    <div className="pricing-page">
      <Seo
        ...
        description="SMSLocal pricing is simple: pay only for messages you send, with no hidden fees or contracts. See live per-country rates and calculate your budget."

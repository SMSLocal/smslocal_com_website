...
export const CONTENT_OVERRIDES = {
  ...
  'what-does-dw-mean-in-text': {
    ...
    metaTitle: 'What Does DW Mean in Text?',
  ...
  'emoji-meaning-in-text': {
    ...
    metaTitle: '230+ Emoji Meanings Guide',
  ...
  'message-blocking-is-active': {
    metaTitle: 'Fix Message Blocking is Active',
  ...
  'how-to-send-a-system-generated-sms': {
    metaTitle: 'How to Send a System-Generated SMS',
    // Went through three rounds to land here: 188 -> 155 -> 120 chars, and
    // even 155 still translated past 200 in ru/de/fr/it — this topic's
    // vocabulary (OTP, triggers, setup) just expands hard. Verified against
    // the live translate endpoint for those four before committing.
    metaDescription:
      'What a system-generated SMS is, and how to send one with a short setup guide.',
